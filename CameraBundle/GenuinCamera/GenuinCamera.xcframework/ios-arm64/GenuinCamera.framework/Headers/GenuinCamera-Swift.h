...
#ifndef GENUINCAMERA_SWIFT_H
#define GENUINCAMERA_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="GenuinCamera",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSCoder;
SWIFT_CLASS("_TtC12GenuinCamera17CamRecorderButton")
@interface CamRecorderButton : UIButton
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder SWIFT_UNAVAILABLE;
@end

SWIFT_CLASS("_TtC12GenuinCamera12GenuinCamera")
@interface GenuinCamera : NSObject
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) GenuinCamera * _Nonnull shared;)
+ (GenuinCamera * _Nonnull)shared SWIFT_WARN_UNUSED_RESULT;
...
///   </li>
/// </ul>
SWIFT_RESILIENT_CLASS("_TtC12GenuinCamera18MultilineTextField")
@interface MultilineTextField : GenuinTextView
...
/// stored in <code>self.placeholderColor</code>.
...
@class UIImageView;
@class NSURL;
SWIFT_PROTOCOL("_TtP12GenuinCamera17SwiftyGifDelegate_")
...
@class NSData;
@interface UIImage (SWIFT_EXTENSION(GenuinCamera))
...
@interface UIImageView (SWIFT_EXTENSION(GenuinCamera))
...
@class UITouch;
@class NSBundle;
SWIFT_RESILIENT_CLASS("_TtC12GenuinCamera26VideoPreviewViewController")
@interface VideoPreviewViewController : BaseViewController <UIGestureRecognizerDelegate, UITextFieldDelegate>
- (void)viewDidLoad;
...
@class GPHMedia;
@interface VideoPreviewViewController (SWIFT_EXTENSION(GenuinCamera)) <GiphyDelegate>
