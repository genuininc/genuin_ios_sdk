...
SWIFT_CLASS("_TtC10GenuinCore8BGAdType")
@interface BGAdType : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

SWIFT_CLASS("_TtC10GenuinCore12BGAdsManager")
@interface BGAdsManager : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
@interface BGAdsManager (SWIFT_EXTENSION(GenuinCore)) <IMAAdsLoaderDelegate>
...
@interface BGAdsManager (SWIFT_EXTENSION(GenuinCore)) <IMALinkOpenerDelegate>
...
@class IMAAdEvent;
@class IMAAdError;
@interface BGAdsManager (SWIFT_EXTENSION(GenuinCore)) <IMAAdsManagerDelegate>
...
@interface BGAdsManager (SWIFT_EXTENSION(GenuinCore)) <GADNativeAdDelegate, GADNativeAdLoaderDelegate, GADVideoControllerDelegate>
...
@class GADBannerView;
@interface BGAdsManager (SWIFT_EXTENSION(GenuinCore)) <GADBannerViewDelegate>
...
SWIFT_CLASS("_TtC10GenuinCore10BGAdsModel")
@interface BGAdsModel : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC10GenuinCore18BGAdsViewModelItem")
@interface BGAdsViewModelItem : BGMainViewModelItem
@end
...
SWIFT_CLASS("_TtC10GenuinCore11BGDisplayAd")
@interface BGDisplayAd : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC10GenuinCore9BGHouseAd")
@interface BGHouseAd : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

SWIFT_CLASS("_TtC10GenuinCore16BGInfeedAdConfig")
@interface BGInfeedAdConfig : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

SWIFT_CLASS("_TtC10GenuinCore18BGInstreamAdConfig")
@interface BGInstreamAdConfig : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC10GenuinCore16BGMonetizePreset")
@interface BGMonetizePreset : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

SWIFT_CLASS("_TtC10GenuinCore10BGNativeAd")
@interface BGNativeAd : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
/// Pangle app id + slot ids, delivered inline on a <code>video_ad</code> entry whose
/// <code>platform</code> is <code>pangle</code>. Every slot id is optional: a missing one just
/// drops that format out of the ladder.
SWIFT_CLASS("_TtC10GenuinCore16BGPangleAdConfig")
@interface BGPangleAdConfig : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

SWIFT_CLASS("_TtC10GenuinCore20BGPangleAdController")
@interface BGPangleAdController : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
@interface BGPangleAdController (SWIFT_EXTENSION(GenuinCore)) <PAGBannerAdDelegate, PAGLInterstitialAdDelegate, PAGLNativeAdDelegate, PAGRewardedAdDelegate>
...
SWIFT_CLASS("_TtC10GenuinCore11BGSponsored")
@interface BGSponsored : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

SWIFT_CLASS("_TtC10GenuinCore9BGVideoAd")
@interface BGVideoAd : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_ENUM_FWD_DECL(NSInteger, GenuinEnvironment)
...
SWIFT_CLASS("_TtC10GenuinCore22GenuinNativeAdCardView")
@interface GenuinNativeAdCardView : UIView
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
- (void)layoutSubviews;
@end

SWIFT_CLASS("_TtC10GenuinCore18GenuinNativeAdView")
@interface GenuinNativeAdView : GADNativeAdView
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end

SWIFT_CLASS("_TtC10GenuinCore24GenuinPangleNativeAdView")
...
/// Renders a 0–5 star rating using SF Symbols (full / half / empty).
SWIFT_CLASS("_TtC10GenuinCore14StarRatingView")
