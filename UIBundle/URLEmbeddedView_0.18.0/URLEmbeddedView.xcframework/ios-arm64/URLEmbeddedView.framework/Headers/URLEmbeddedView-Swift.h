...
#ifndef URLEMBEDDEDVIEW_SWIFT_H
#define URLEMBEDDEDVIEW_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="URLEmbeddedView",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)

SWIFT_CLASS("_TtC15URLEmbeddedView22AttributedTextProvider")
@interface AttributedTextProvider : NSObject
...
@interface NSNumber (SWIFT_EXTENSION(URLEmbeddedView))
...
/// OGP cache object
SWIFT_CLASS("_TtC15URLEmbeddedView11OGCacheData")
...
SWIFT_PROTOCOL("_TtP15URLEmbeddedView26OGDataCacheManagerProtocol_")
...
/// Has no OGP cache
SWIFT_CLASS("_TtC15URLEmbeddedView20OGDataNoCacheManager")
...
SWIFT_CLASS("_TtC15URLEmbeddedView14OGDataProvider")
...
SWIFT_CLASS("_TtC15URLEmbeddedView15OGImageProvider")
...
SWIFT_CLASS("_TtC15URLEmbeddedView13OpenGraphData")
...
SWIFT_CLASS("_TtC15URLEmbeddedView23OpenGraphDataDownloader")
...
SWIFT_CLASS("_TtC15URLEmbeddedView4Task")
...
SWIFT_CLASS("_TtC15URLEmbeddedView15URLEmbeddedView")
@interface URLEmbeddedView : UIView
@property (nonatomic, readonly, strong) AttributedTextProvider * _Nonnull textProvider;
@property (nonatomic, copy) void (^ _Nullable didTapHandler)(URLEmbeddedView * _Nonnull, NSURL * _Nullable);
@property (nonatomic) BOOL shouldContinueDownloadingWhenCancel;
- (nonnull instancetype)init;
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithUrl:(NSString * _Nonnull)url;
- (nonnull instancetype)initWithUrl:(NSString * _Nonnull)url frame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (void)awakeFromNib;
- (void)touchesBegan:(NSSet<UITouch *> * _Nonnull)touches withEvent:(UIEvent * _Nullable)event;
- (void)touchesCancelled:(NSSet<UITouch *> * _Nonnull)touches withEvent:(UIEvent * _Nullable)event;
- (void)touchesEnded:(NSSet<UITouch *> * _Nonnull)touches withEvent:(UIEvent * _Nullable)event;
- (void)loadWithURLString:(NSString * _Nonnull)urlString completion:(void (^ _Nullable)(NSError * _Nullable))completion;
- (void)load:(void (^ _Nullable)(NSError * _Nullable))completion;
- (void)cancelLoading;
@end

@class UIColor;

@interface URLEmbeddedView (SWIFT_EXTENSION(URLEmbeddedView))
@property (nonatomic) IBInspectable CGFloat cornerRaidus;
